...
srk_image = face_recognition.load_image_file("recogized_faces/srk.jpg")
srk_encoding = face_recognition.face_encodings(srk_image)[0]

salman_image = face_recognition.load_image_file("recogized_faces/Salman.jpg")
salman_encoding = face_recognition.face_encodings(salman_image)[0]

jag_image = face_recognition.load_image_file("recogized_faces/jag.jpg")
jag_encoding = face_recognition.face_encodings(jag_image)[0]

tus_image = face_recognition.load_image_file("recogized_faces/tus.jpg")
tus_encoding = face_recognition.face_encodings(tus_image)[0]

known_face_encodings = [srk_encoding, salman_encoding, jag_encoding, tus_encoding]
known_face_names = ["srk", "salman", "jagruth", "tushar"]
